...
Source of truth: [skills/reference.md](./skills/reference.md) (`pass` | `fail` | `blocked`, mandatory-inputs gate, local plugin `PLAN.md` + trailing heading **✅** / **❌**, npm scripts, OpenAPI, generated types).
